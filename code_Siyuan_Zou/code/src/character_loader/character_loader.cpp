...
character_structure load_character_lola()
{
	...
	std::cout << "lola character loaded" << std::endl;

	return character;
}

// initialize my character
character_structure load_character_girl()
{
	filename_loader_structure loader_param;
	loader_param.set_skeleton(project::path + "assets/kachujin/skeleton/");
	loader_param.add_rigged_mesh("body", project::path + "assets/kachujin/mesh-kachujin/", project::path + "assets/kachujin/mesh-kachujin/texture.png");
	loader_param.add_rigged_mesh("sword", project::path + "assets/kachujin/mesh-sword/", project::path + "assets/kachujin/mesh-sword/texture.png");
	loader_param.add_animation("Idle", project::path + "assets/kachujin/animation/sword_idle/");
	loader_param.add_animation("Walk", project::path + "assets/kachujin/animation/sword_walk_still/");
	loader_param.add_animation("Walk_Back", project::path + "assets/kachujin/animation/sword_walk_back_still/");
	loader_param.add_animation("Stab", project::path + "assets/kachujin/animation/sword_stab/");
	// loader_param.add_animation("Slash", project::path + "assets/kachujin/animation/sword_slash/");

	character_structure character;
	character.load_and_initialize(loader_param, affine_rts().set_scaling(0.01f));

	std::cout << "girl character loaded" << std::endl;
